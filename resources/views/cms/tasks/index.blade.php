...
{{-- 
                      <td>
                        <a href="{{route('task.edit-permissions',$task->id)}}" type="button" class="btn btn-block btn-outline-primary btn-sm">({{$task->permissions_count}})  Permission/s 
                        </a>
                    </td> --}}
                    
                   
                        <div class="btn-group">
                        <a href="{{route('tasks',$task->id)}}" class="btn btn-warning ">
                          <i class="fas fa-edit"></i>

                        </a>
                        <a href="#"  onclick="performDelete('{{$task->id}}')" class="btn btn-danger">
                          <i class="fas fa-trash"></i>
                        </a>
                      
                       {{-- <form method="POST" action="{{route('subCdestroy',$task->id)}}">
                      @method('DELETE')
                      @csrf
